...
var spMonitoring={
    ...
    spGridLinkInt:function(){
        ...
        spTbody.children("tr").each(function(){
            $(this).click(function(){
                window.location.href=window.location.origin+window.location.pathname+"#/spGridlink?trHost="+encodeURIComponent($(this).attr("trHost"));
            ...
            success: function(data){
                if(data){
                    ...
                    for(var si=0;si<data.length;si++){
                        ...
                        spTableHtml+="<tr trHost="+data[si].host+"><td>"+data[si].id+"</td><td>"+data[si].host+"</td><td><span class="+textClass+">"+data[si].http+"</span></td><td><span class="+gaojingClass+"></span></td><td>"+data[si].stratTime+"</td><td>"+data[si].shichan+"</td><td>"+data[si].unum+"</td><td>"+data[si].liulian+"</td><td>"+data[si].ywulian+"</td><td>"+data[si].errortime+"</td><td><span class='analButton'>分析</span></td></tr>";
                    }
                    ...
                    series : [
                        {
                            ...
                            center: ['45%', '40%'],
                            data:[
                                {value:data.zdsp, name:'重点监控SP'+data.zdsp+"个",
                                    itemStyle:{normal:{
                                        color:'#86bb6e',
                                        borderColor:'#86bb6e',
                                        borderWidth:'3',
                                ...
                                {value:data.ptsp, name:'普通告警SP'+data.ptsp+"个",
                                    itemStyle:{normal:{color:'#f68f52'}}
                                },
                                {value:data.yzsp, name:'严重告警SP'+data.ptsp+"个",
...
* */
    ...
    spYichangListInt:function(){
        var scope=this;
        var leftData=[{"time":"2015/12/1 12:30:00","https":"65.23%","id":1000},{"time":"2015/12/1 12:45:00","https":"71.55%","id":1001},{"time":"2015/12/1 13:00:00","https":"63.27%","id":1002}];
        var splistTbody=$("#splistTbody");
        var spHtml="";
        for(var i=0;i<leftData.length;i++){
            spHtml+="<tr id="+leftData[i].id+"><td class='tdPadding'>"+leftData[i].time+"</td><td><span class='redTd'>"+leftData[i].https+"</span></td></tr>";
        }
    ...
    rightYclist:function(id){
        var listData;
        if(id==1000){
            listData=[{"weidu":"PGW_IP 10.135.46.79","hissu":"96.23%","nowsu":"50.45%","yixdu":"63.32%"},
                {"weidu":"PGW_IP 10.135.46.80","hissu":"91.23%","nowsu":"75.87%","yixdu":"13.12%"},
                {"weidu":"APN CMHK","hissu":"96.76%","nowsu":"52.21%","yixdu":"83.25%"},
                {"weidu":"SP_IP 132.123.56.68","hissu":"95.67%","nowsu":"32.62%","yixdu":"45.76%"},
                {"weidu":"SP_IP 132.123.56.69","hissu":"89.88%","nowsu":"69.87%","yixdu":"28.99%"}
            ];
        }else if(id==1001){
            listData=[
                {"weidu":"SP_IP 132.123.56.68","hissu":"95.67%","nowsu":"32.62%","yixdu":"45.76%"},
                {"weidu":"SP_IP 132.123.56.69","hissu":"89.88%","nowsu":"69.87%","yixdu":"28.99%"},
                {"weidu":"PGW_IP 10.135.46.79","hissu":"96.23%","nowsu":"50.45%","yixdu":"63.32%"},
                {"weidu":"PGW_IP 10.135.46.80","hissu":"91.23%","nowsu":"75.87%","yixdu":"13.12%"},
                {"weidu":"APN CMHK","hissu":"96.76%","nowsu":"52.21%","yixdu":"83.25%"}
        ...
        for(var i=0;i<listData.length;i++){
            thisHtml+="<tr><td class='tdPadding'>"+listData[i].weidu+"</td><td><span class='orangeTd'>"+listData[i].hissu+"</span></td><td>"+listData[i].nowsu+"</td><td>"+listData[i].yixdu+"</td></tr>";
        }
    ...
    qushiTabHtmlInt:function(thisID){
        ...
        if(thisID=="pwgBlock"){
            nametype.text("IP");
            listData=[
                {"ip":"10.135.46.79","hissu":"96.23%","nowsu":"50.45%","yiadu":"63.32%"},
                {"ip":"10.135.46.80","hissu":"91.23%","nowsu":"75.87%","yiadu":"13.12%"}
            ];
            ...
            listData=[
                {"ip":"10.135.46.79","hissu":"96.23%","nowsu":"50.45%","yiadu":"63.32%"},
                {"ip":"10.135.46.80","hissu":"98.55%","nowsu":"72.02%","yiadu":"2.71%"}
            ];
        }
        var spTabletbody=$("#spTabletbody");
        var thisHtml="";
        for(var i=0;i<listData.length;i++){
            thisHtml+="<tr><td>"+listData[i].ip+"</td><td>"+listData[i].hissu+"</td><td class='red'>"+listData[i].nowsu+"</td><td>"+listData[i].yiadu+"</td></tr>";
        }
    ...
    spReasonMInt:function(thisID){
        var newData=[];
        if(thisID=="pwgBlock"){
            newData=[97.04,93,92,88,89,90,92,94,96,98,98.52,98.49,98.48,95.39,97.15,93.00,89.78,80.39,70.59,60.36];
        }else if(thisID=="apnBlock"){
            newData=[97.04,93,92,88,89,90,92,94,96,98,98.52,98.49,98.48,95.39,97.15,93.00,89.78,80.39,70.59,60.36];
        }else{
            newData=[97.04,93,92,88,89,90,92,94,96,98,98.52,98.49,98.48,95.39,97.15,93.00,89.78,80.39,70.59,60.36];
        ...
        var option = {
            ...
            xAxis : [
                {
                    type : 'category',
                    boundaryGap : true,
                    data : ['2015/11/25 0:00','2015/11/25 0:15','2015/11/25 0:30','2015/11/25 0:45','2015/11/25 1:00',
                        '2015/11/25 1:15','2015/11/25 1:30','2015/11/25 1:45','2015/11/25 2:00',
                        '2015/11/25 2:15','2015/11/25 2:30','2015/11/25 2:45','2015/11/25 3:00',
                        '2015/11/25 3:15','2015/11/25 3:30','2015/11/25 3:45','2015/11/25 4:00',
                        '2015/11/25 4:15','2015/11/25 4:30','2015/11/25 4:15'
                    ],
                    axisLabel:{
                        interval:0,
                        rotate:62,
            ...
            series : [
                ...
                },
                {
                    ...
                    data:[98.08,98.52,98.49,90.88,97.37,93.00,96.78,96.39,90.59,93.36,97.04,96.89,96.29,86.18,84.82,78.72,70.42,64.63,63,59]
                }
            ]
        };
        //...使用
    ...
    webAboutTableInt:function(index,thisID){
        var newData=[],nameVlue;
        if(index==0){
            newData=[97.04,93,92,88,89,90,92,94,96,98,98.52,98.49,98.48,95.39,97.15,93.00,89.78,80.39,70.59,60.36];
        }else{
            newData=[96,98,98.52,98.49,98.48,95.39,97.15,97.04,93,92,88,89,90,92,94,93.00,89.78,80.39,70.59,60.36];
        }
        if(thisID=="pwgBlock"){
            nameVlue="PGW_IP";
        }else if(thisID=="apnBlock"){
